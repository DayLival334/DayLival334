...
![Pawn](https://img.shields.io/badge/Pawn-Script-FF6600?style=for-the-badge&logo=data:image/png;base64,&logoColor=white)
...
<table>
  <tr>
    <td align="center" width="50%">
      ...
      <p>Building full-stack web applications from database design to UI — REST APIs, SPA, SSR, and everything in between.</p>
    </td>
    <td align="center" width="50%">
      <h3>🤖 Data & AI</h3>
      <p>Exploring machine learning, data pipelines, and AI-powered tools. Python + SQL is my go-to combo for analysis.</p>
    </td>
  </tr>
  <tr>
    <td align="center" width="50%">
      <h3>⚙️ Systems & C/C++</h3>
      <p>Low-level programming, performance-critical code, embedded systems, and algorithm optimization.</p>
    </td>
    <td align="center" width="50%">
      <h3>🎮 Pawn / Game Scripting</h3>
      <p>Scripting game servers and mods with Pawn — custom game logic, plugins, and automation.</p>
    </td>
  </tr>
</table>
